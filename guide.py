...
def show(app, navigate):
    ...
    #aide body
    aide_frame = customtkinter.CTkFrame(app, bg_color=WHITE,
                                        fg_color="transparent")
    aide_frame.pack(fill="both", expand=True, padx=14, pady=(10, 14))

    # sidebar
    sidebar = customtkinter.CTkScrollableFrame(aide_frame, bg_color=WHITE,
                                            fg_color=WHITE, 
                                            corner_radius=12, 
                                            width=220)
    ...
    #  contenu
    content = customtkinter.CTkScrollableFrame(aide_frame, bg_color=WHITE,
                                            fg_color=WHITE, 
                                            corner_radius=12)
